...
function deploy(target, capistranoCommand, options) {
  return __awaiter(this, void 0, void 0, function* () {
    let args = [];
    if (!target) {
      args = ['exec', 'cap', capistranoCommand];
    } else {
      args = ['exec', 'cap', target, capistranoCommand];
    }
...
function run() {
  return __awaiter(this, void 0, void 0, function* () {
    const capistranoCommand = core.getInput('capistrano_command');
    ...
    yield deploy(target, capistranoCommand, options);
  });
}
